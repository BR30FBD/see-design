  ...
  return (
    ...
    <div className="row">
        ...
        <div className="col-md-5 border-right">
            <div className="p-3 py-5">
                ...
                <div className="row mt-3">
                    ...
                    <div className="col-md-12"><label className="labels">MEMBER ID</label><input type="text" className="form-control" placeholder="ABCXXXX" value=""/></div>
                </div>
                <div className="row mt-3">
        ...
        <div className="col-md-4">
            <div className="p-3 py-5">
                <div className="d-flex justify-content-between align-items-center experience"><span>

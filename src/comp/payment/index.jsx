        ...
        <div class="card-body p-4">
          ...
          <form action="">
            ...
            <div class="d-flex flex-row align-items-center mb-4 pb-1">
              <img class="img-fluid" src="https://pngimg.com/uploads/mastercard/mastercard_PNG23.png" style={{width:"50px"}} />
            ...
            <div class="d-flex flex-row align-items-center mb-4 pb-1">
              <img class="img-fluid" src="https://www.visa.co.in/dam/VCOM/regional/ap/india/global-elements/images/in-visa-gold-card-498x280.png" style={{width:"50px"}} />
              <div class="flex-fill mx-3">
                <div class="form-outline">
            ...
            <button class="btn btn-success btn-lg bg-primary btn-block">Add card</button>
          </form>
        </div>
      </div>
    </div>

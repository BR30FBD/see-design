...
<p>Come to MAX to discover how Creative Cloud can fuel your creativity. Learn new skills and find inspiration.</p>
  ...
  <div class="col">
    <div class="card h-100">
      <img src="https://wwwimages.adobe.com/content/dam/acom/images/shared/retention_background_images/high_res/CCPP@2x.png" class=" card-img-top" alt="..." style={{height:"200px"}}/>
      <div class="card-body">
...
<div style={{display:"flex",justifyContent:"space-around"}}>
  ...
  <div style={{marginBottom:"100%",}}>
    ...
    <div style={{display:"flex",alignItems:"center", flexDirection:"column"}}>
        <h5 className='text-dark'>Nitish kushwaha</h5>

...
ctx2.fillText(`${((c*25.4)/96).toFixed(3)+"MM"}`,pI[0].offsetX,pI[0].offsetY);
  ...
  function rectangle({ x, y, pI, ctx2, width, height }) {
    ...
    ctx2.fillText(`${(((x - pI[0].offsetX)*25.4)/96).toFixed(3)}x${(((y - pI[0].offsetY)*25.4)/96).toFixed(3)}`,pI[0].offsetX,y- pI[0].offsetY, x - pI[0].offsetX);
...
ctx2.fillText(`${(((x - pI[0].offsetX)*25.4)/96).toFixed(3)}x${(((y - pI[0].offsetY)*25.4)/96).toFixed(3)}`,pI[0].offsetX,y- pI[0].offsetY, x - pI[0].offsetX);
    ...
    ctx2.stroke();
    console.log( pI[0].offsetX, pI[0].offsetY, x - pI[0].offsetX, y - pI[0].offsetY,"d")
  }
